    ...
    >
      <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-6">
          <a
            href="https://www.linkedin.com/in/yashaswivemu/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-slate-500 hover:text-primary-400 text-sm transition-colors inline-flex items-center gap-2"
          >
          ...
          <a
            href="https://github.com/vemuyash-debug"
            target="_blank"
            rel="noopener noreferrer"
            className="text-slate-500 hover:text-primary-400 text-sm transition-colors inline-flex items-center gap-2"
          >
